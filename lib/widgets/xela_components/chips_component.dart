                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        XelaChip(
                            text: "Label",
                            leftIconInactive: Icon(Icons.grid_view,
                                size: 20,
                                color: _isDark
                                    ? XelaColor.Blue5
                                    : XelaColor.Blue3),
                            leftIconActive: Icon(Icons.grid_view,
                                size: 20,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        XelaChip(
                            text: "Label",
                            rightButtonInactive: Icon(Icons.grid_view,
                                size: 20,
                                color: _isDark
                                    ? XelaColor.Blue5
                                    : XelaColor.Blue3),
                            rightButtonActive: Icon(Icons.grid_view,
                                size: 20,
                                color: _isDark ? Colors.white : Colors.white),
                            defaultBackgroundColor:
                                _isDark ? Colors.transparent : Colors.white,
                    ...
                    child: Row(
                      ...
                      children: [
                        XelaChip(
                          ...
                          text: "Label",
                          defaultBackgroundColor:
                              _isDark ? XelaColor.Gray3 : Colors.white,
                          selectedBackgroundColor:
                              _isDark ? XelaColor.Gray3 : XelaColor.Blue11,
                          defaultContentColor:
                              _isDark ? XelaColor.Gray11 : XelaColor.Gray6,
                          selectedContentColor:
                              _isDark ? XelaColor.Blue6 : XelaColor.Blue3,
                          defaultBorderColor:
                              _isDark ? XelaColor.Gray5 : XelaColor.Gray10,
                          selectedBorderColor:
                              _isDark ? XelaColor.Blue6 : XelaColor.Blue6,
                          borderWidth: 1,
                        ),
                        XelaChip(
                          size: XelaChipSize.MEDIUM,
                    ...
                    child: Row(
                      ...
                      children: [
                        XelaChip(
                          ...
                          selectedBackgroundColor:
                              _isDark ? XelaColor.Blue8 : XelaColor.Blue12,
                          defaultContentColor:
                              _isDark ? XelaColor.Gray11 : XelaColor.Gray6,
                          selectedContentColor:
                              _isDark ? XelaColor.Blue2 : XelaColor.Blue3,
                          defaultBorderColor: Colors.transparent,
                          selectedBorderColor: Colors.transparent,
                          borderWidth: 1,
                        ),
