      ...
      child: Opacity(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(
              top: widget.size == XelaChipSize.LARGE
                  ? 12
                  : widget.size == XelaChipSize.MEDIUM
                      ? 8
                      : 4,
              bottom: widget.size == XelaChipSize.LARGE
                  ? 12
                  : widget.size == XelaChipSize.MEDIUM
                      ? 8
                      : 4,
              left: widget.size == XelaChipSize.SMALL ||
                      (widget.size == XelaChipSize.MEDIUM &&
                          widget.leftIconInactive != null)
                  ? 8
                  : 12,
              right: widget.rightButtonInactive != null &&
                      widget.size != XelaChipSize.LARGE
                  ? widget.size == XelaChipSize.MEDIUM
                      ? 8
                      : 4
                  : 12),
