        ...
        child: Opacity(
          ...
          child: SliderTheme(
              data: SliderTheme.of(context).copyWith(
                  ...
                  thumbShape:
                      XelaSliderThumbShape(thumbRadius: 28, active: active),
                  ...
                  valueIndicatorShape: widget.vertical
              ...
              child: Slider(
                ...
                value: currentValue,
                label:
                    widget.showLabel ? currentValue.toInt().toString() : null,
                onChangeStart: (value) {
                  if (widget.disabled) {
                    return;
                  }
...
class XelaSliderTrackShape extends RoundedRectSliderTrackShape {
  ...
  void paint(
    ...
    final Radius activeTrackRadius = Radius.circular(
        (trackRect.height + (active ? additionalActiveTrackHeight : 0)) / 2);
    ...
    context.canvas.drawRRect(
      RRect.fromLTRBAndCorners(
        ...
        (textDirection == TextDirection.ltr)
            ? trackRect.bottom +
                ((active ? additionalActiveTrackHeight : 0) / 2)
            : trackRect.bottom,
...
class XelaSliderThumbShape extends SliderComponentShape {
  ...
  XelaSliderThumbShape({required this.thumbRadius, required this.active});
...
class XelaSliderValueIndicatorShape extends SliderComponentShape {
  ...
  static const _XelaSliderValueShapePathPainter _pathPainter =
      _XelaSliderValueShapePathPainter();
