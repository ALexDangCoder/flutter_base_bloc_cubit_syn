...
import 'package:bnv_opendata/utils/flutter_switch.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        FlutterSwitch(
          width: widget.size == XelaToggleSize.LARGE
              ? 56
              : widget.size == XelaToggleSize.MEDIUM
                  ? 48
                  : 32,
          height: widget.size == XelaToggleSize.LARGE
              ? 32
              : widget.size == XelaToggleSize.MEDIUM
                  ? 24
                  : 16,
          toggleSize: widget.size == XelaToggleSize.LARGE
              ? 24
              : widget.size == XelaToggleSize.MEDIUM
                  ? 20
                  : 14,
          value: widget.status,
          borderRadius: 100.0,
          padding: widget.size == XelaToggleSize.LARGE
              ? 4
              : widget.size == XelaToggleSize.MEDIUM
                  ? 2
                  : 1,
