...
class _XelaUserAvatarState extends State<XelaUserAvatar> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      alignment:
          widget.decorationPosition == XelaUserAvatarDecorationPosition.TOPRIGHT
              ? Alignment.topRight
        ...
        Container(
          ...
          width: widget.size == XelaUserAvatarSize.LARGE
              ...
              : widget.size == XelaUserAvatarSize.MEDIUM
                  ? 48
                  : 32,
          height: widget.size == XelaUserAvatarSize.LARGE
              ? 64
              : widget.size == XelaUserAvatarSize.MEDIUM
                  ? 48
                  : 32,
          decoration: BoxDecoration(
              shape: widget.style == XelaUserAvatarStyle.RECTANGLE
                  ? BoxShape.rectangle
                  : BoxShape.circle,
              borderRadius: widget.style == XelaUserAvatarStyle.RECTANGLE
